...
int cmp(const void* a, const void* b) {
    ...
    // 3 - первые n букв, по которым происходит сортировка, т.е. например n = 2; МИ и МА отсортирует как МА и МИ
}
...
//strtok(str1, str2) разбивает строку str1 на кусочки ограниченные символами, входящими в строку str2
//(кусочки - "токены", отсюда strtok, ..tok - token)
int example12(void)
{
